...
#### Feature number 5: _O aluno decide se esta informação no seu dashboard deve ser pública ou privada_
 ...
 - [x] [Cypress use case test](https://github.com/tecnico-softeng/es20al_21-project/blob/tdp/frontend/tests/e2e/specs/student/dashboard/changePrivacyTest.js)
 + Screenshots:
...
#### Feature number 1: _Se o número de alunos inscritos, incluindo o criador do torneio, for superior a 1, o sistema gera o quiz associado ao torneio_
 ...
 - [x] [Service](https://github.com/tecnico-softeng/es20al_21-project/blob/tdp/backend/src/main/java/pt/ulisboa/tecnico/socialsoftware/tutor/tournament/TournamentService.java)
 - [x] [Spock tests](https://github.com/tecnico-softeng/es20al_21-project/blob/tdp/backend/src/test/groovy/pt/ulisboa/tecnico/socialsoftware/tutor/tournament/service/TournamentGeneratesQuizTest.groovy)
 - [x] [JMeter feature tests](https://github.com/tecnico-softeng/es20al_21-project/blob/tdp/backend/jmeter/Tournament/Tournament'sAssociatedQuizWebServiceTest.jmx)
   + Screenshots:
...
#### Feature number 3: Existe um dashboard do aluno onde é apresentada informação acerca dos torneios em que participou e qual a sua pontuação
 ...
 - [x] [Service](https://github.com/tecnico-softeng/es20al_21-project/blob/tdp/backend/src/main/java/pt/ulisboa/tecnico/socialsoftware/tutor/statistics/StatsService.java)
 - [x] [Spock tests](https://github.com/tecnico-softeng/es20al_21-project/blob/tdp/backend/src/test/groovy/pt/ulisboa/tecnico/socialsoftware/tutor/statistics/service/DashboardStatisticsTest.groovy)
 - [x] [JMeter feature test](https://github.com/tecnico-softeng/es20al_21-project/blob/tdp/backend/jmeter/Tournament/TournamentStatisticsTest.jmx)
...
#### Feature number 4: O aluno decide se esta informação no seu dashboard deve ser pública ou privada
 ...
 - [x] [Service](https://github.com/tecnico-softeng/es20al_21-project/blob/tdp/backend/src/main/java/pt/ulisboa/tecnico/socialsoftware/tutor/user/UserService.java)
 - [x] [Spock tests](https://github.com/tecnico-softeng/es20al_21-project/blob/tdp/backend/src/test/groovy/pt/ulisboa/tecnico/socialsoftware/tutor/user/domain/user/UserPrivacyTest.groovy)
 - [x] [JMeter feature test](https://github.com/tecnico-softeng/es20al_21-project/blob/tdp/backend/jmeter/Stats/ChangeDashboardPrivacy%20test.jmx)
