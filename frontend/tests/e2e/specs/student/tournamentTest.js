describe('Tournament Tests', () => {
  ...
  it('login checks tournaments list', () => {
    cy.exec(
      'PGPASSWORD=tgllvg99 psql -d tutordb -U pedro -h localhost -c "INSERT INTO tournaments (id,available_date,conclusion_date,creation_date,title,course_execution_id,user_id) VALUES (1001 , \'2020-04-20 14:19:00\' , \'2020-08-20 14:20:00\' , \'2020-08-19 15:18:25\' , \'Torneio1\' , 11 , 676);" '
    );
    ...
    cy.exec(
      'PGPASSWORD=tgllvg99 psql -d tutordb -U pedro -h localhost -c "INSERT INTO tournaments_signed_users VALUES (1001 , 700);" '
    );
